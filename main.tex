...
\title{用于脑卒中快速鉴别的生成式EIT图像重建算法研究}{Research on Generative EIT Image Reconstruction Algorithm for Fast Detection of Stroke}
...
\addcommitteemember{西安交通大学,董渭清,教授}
\addcommitteemember{西安交通大学,赵加坤,副教授}
\addcommitteemember{西安交通大学,蔺杰,教授}
\addcommitteemember{西安交通大学,雷浩,副研究员}

% 答辩时间（手动指定）
% Defence date, input manually
\defensedate{2024}{05}{10}

% 答辩地点（涉密论文请手动设置为「西安交通大学」）
% Defence location, default value is 「西安交通大学」
\defenseloc{兴庆 中2-2243}
