...
\begin{figure}[h]
    \centering
    \includegraphics[width=.9\textwidth]{DP.jpg}
    \caption{正向过程}
    \label{figure:dp}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.5\textwidth]{CLIPLoss.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.5\textwidth]{DDPMLoss.PNG}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.5\textwidth]{DecoderLoss.png}
