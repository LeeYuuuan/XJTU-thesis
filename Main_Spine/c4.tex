...
\begin{figure}[h]
    \centering
    \includegraphics[width=.5\textwidth]{expvol.JPG}
...
\xsubsection{优化后的EIT物理模型试验图像重建结果}
...
\xsubsection{优化后EC-Diffusion算法对于噪声的鲁棒性分析}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{noiseV.png}
    \caption{带噪声的电压分示意图}
    \label{figure:noiseV}
\end{figure}
