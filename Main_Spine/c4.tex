...
\xsubsection{EIT物理模型试验数据采集}{Data Acquisition of EIT Physical Model Experiment}
...
\xsubsection{EIT物理模型试验图像重建结果}{Image Reconstruction Results of EIT Physical Model Experiment after Optimization}
